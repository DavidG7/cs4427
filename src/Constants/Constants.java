...
public final class Constants {
	...
	public static final String ENEMEY_MOVES
            = "Enemy moves";
	public static final String ENEMY_DOESNT_MOVE
            = "Enemy doesn't move";
	...
	public static final String ATTACH_DIFFICULTYUI
            = "Difficulty UI attached";
	public static final String ATTACH_ZOMBIE
            = "Zombie attached to Difficulty and Player";
	public static final String ATTACH_MONSTER
            = "Monster attached to Difficulty and Player";
	public static final String ZOMBIE_MOVEMENT
            = "Zombie movement updated to";
	public static final String MONSTER_MOVEMENT
            = "Monster movement updated to";
	public static final String PLAYER_AT= "Player at";
	
	public static final String MOVES_UP_OUTPUT
            = "Player moves up, new position is";
	public static final String MOVES_DOWN_OUTPUT
            = "Player moves down, new position is";
	public static final String MOVES_LEFT_OUTPUT
            = "Player moves left, new position is";
	public static final String MOVES_RIGHT_OUTPUT
            = "Player moves right, new position is";
	
	public static final String NEG_MOVES_UP_OUTPUT
            = "Not possible to move up";
	public static final String NEG_MOVES_DOWN_OUTPUT
            = "Not possible to move down";
	public static final String NEG_MOVES_LEFT_OUTPUT
            = "Not possible to move left";
	public static final String NEG_MOVES_RIGHT_OUTPUT
	...
	public static final String NO_MORE_MOVE_RESPONSE
            = "No more moves to undo";
	public static final String GAME_PASSED_RESPONSE
